...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S1-02");
...
describe("goal-mode length eval GM-S1-02", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S1-02-manifest.json");
