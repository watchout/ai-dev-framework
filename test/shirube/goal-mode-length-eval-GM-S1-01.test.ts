...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S1-01");
...
describe("goal-mode length eval GM-S1-01", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S1-01-manifest.json");
