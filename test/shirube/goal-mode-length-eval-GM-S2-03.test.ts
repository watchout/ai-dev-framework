...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S2-03");
...
describe("goal-mode length eval GM-S2-03", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S2-03-manifest.json");
