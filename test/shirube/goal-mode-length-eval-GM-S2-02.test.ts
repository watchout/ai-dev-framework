...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S2-02");
...
describe("goal-mode length eval GM-S2-02", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S2-02-manifest.json");
