...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S3-01");
...
describe("goal-mode length eval GM-S3-01", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S3-01-manifest.json");
