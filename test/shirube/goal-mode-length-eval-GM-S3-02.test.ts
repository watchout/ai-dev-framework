...
const fixtureDir = path.join(root, "test/fixtures/shirube/goal-mode-length-eval/GM-S3-02");
...
describe("goal-mode length eval GM-S3-02", () => {
  it("matches the predeclared acceptance fixture assertions", () => {
    const manifest = readJson<TrialManifest>("GM-S3-02-manifest.json");
