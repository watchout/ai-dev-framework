...
### 1.7 🔒 SSOT 完全性（Example-driven セクション）

> **実装開始前の必須チェック。1つでも ☐ なら実装を開始してはならない。**
> 参照: 12_SSOT_FORMAT.md, 13_SSOT_AUDIT.md Pre-Implementation Readiness Check

| # | 観点 | 確認 | 備考 |
|---|------|------|------|
| 1 | §3-E 入出力例が5ケース以上あるか（正常2+異常3） | ☐ | |
| 2 | §3-F 境界値が全データ項目で定義されているか | ☐ | |
| 3 | §3-G 例外応答が全エラーケースで定義されているか | ☐ | |
| 4 | §3-H Gherkin テストが全MUST要件に対応しているか | ☐ | |
| 5 | SSOT冒頭の完全性チェックリストが全項目 ✅ か | ☐ | |
| 6 | [CORE]/[CONTRACT]/[DETAIL] 層タグが付与されているか | ☐ | |
