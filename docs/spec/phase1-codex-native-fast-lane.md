...
- Origin Issue: #275
- Parent Issue: #266
- Depends on: #269 delivery profile, #270 Work Order defaults, #271 runner
  instruction packs
- Related: #264 4MCP safety profile, #268 GitHub queue projection, #272 AUN
  bridge
...
- runner policy fields in the bundled delivery profile;
- profile validator checks for runner policy safety;
- Work Order default resolution for runner policy inheritance;
- workflow check regression for R3 fast-lane misuse;
- docs and roadmap trace.
